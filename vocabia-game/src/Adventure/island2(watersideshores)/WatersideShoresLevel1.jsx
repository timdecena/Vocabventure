...
const scribblashQuestions = [
  ...
  // Question 3: 4 Pics 1 Word
  {
    type: "4pics1word",
    images: [
      "https://via.placeholder.com/150x100/4a90e2/ffffff?text=Ocean+Wave",
      "https://via.placeholder.com/150x100/4a90e2/ffffff?text=Swimming+Pool", 
      "https://via.placeholder.com/150x100/4a90e2/ffffff?text=Rain+Drop",
      "https://via.placeholder.com/150x100/4a90e2/ffffff?text=Glass+of+Water"
    ],
    letters: "RETAWKLO",
    correct: "WATER"
  },
  ...
  // Question 8: 4 Pics 1 Word
  {
    type: "4pics1word",
    images: [
      "https://via.placeholder.com/150x100/e74c3c/ffffff?text=Library+Books",
      "https://via.placeholder.com/150x100/e74c3c/ffffff?text=Reading+Person",
      "https://via.placeholder.com/150x100/e74c3c/ffffff?text=Open+Book",
      "https://via.placeholder.com/150x100/e74c3c/ffffff?text=Bookstore"
    ],
    letters: "KOOBSRED",
    correct: "BOOKS"
  }
      ...
      async function saveProgress() {
        try {
          ...
          await axios.post('/api/adventure/level-progress/save', {
            levelName: "Scribblash's Sandy Scrawl",
            completed: true,
            starsEarned: hearts
          }, {
