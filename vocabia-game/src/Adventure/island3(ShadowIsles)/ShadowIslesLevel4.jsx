...
// Umbrosk Monster - Placeholder (user will provide actual images)
const UmbroskIdle1 = 'https://img.freepik.com/premium-vector/monster-blue-golem-pixel-art-style-perfect-sticker-mascot-game-character_515427-234.jpg';
const UmbroskIdle2 = 'https://img.freepik.com/premium-vector/monster-blue-golem-pixel-art-style-perfect-sticker-mascot-game-character_515427-234.jpg';
const UmbroskIdle3 = 'https://img.freepik.com/premium-vector/monster-blue-golem-pixel-art-style-perfect-sticker-mascot-game-character_515427-234.jpg';
const UmbroskIdle4 = 'https://img.freepik.com/premium-vector/monster-blue-golem-pixel-art-style-perfect-sticker-mascot-game-character_515427-234.jpg';
const UmbroskAttack1 = 'https://img.freepik.com/premium-vector/monster-blue-golem-pixel-art-style-perfect-sticker-mascot-game-character_515427-234.jpg';
const UmbroskAttack2 = 'https://img.freepik.com/premium-vector/monster-blue-golem-pixel-art-style-perfect-sticker-mascot-game-character_515427-234.jpg';
const UmbroskAttack3 = 'https://img.freepik.com/premium-vector/monster-blue-golem-pixel-art-style-perfect-sticker-mascot-game-character_515427-234.jpg';
const UmbroskAttack4 = 'https://img.freepik.com/premium-vector/monster-blue-golem-pixel-art-style-perfect-sticker-mascot-game-character_515427-234.jpg';
const UmbroskHurt1 = 'https://img.freepik.com/premium-vector/monster-blue-golem-pixel-art-style-perfect-sticker-mascot-game-character_515427-234.jpg';
const UmbroskHurt2 = 'https://img.freepik.com/premium-vector/monster-blue-golem-pixel-art-style-perfect-sticker-mascot-game-character_515427-234.jpg';
const UmbroskHurt3 = 'https://img.freepik.com/premium-vector/monster-blue-golem-pixel-art-style-perfect-sticker-mascot-game-character_515427-234.jpg';
const UmbroskDeath1 = 'https://img.freepik.com/premium-vector/monster-blue-golem-pixel-art-style-perfect-sticker-mascot-game-character_515427-234.jpg';
const UmbroskDeath2 = 'https://img.freepik.com/premium-vector/monster-blue-golem-pixel-art-style-perfect-sticker-mascot-game-character_515427-234.jpg';
const UmbroskDeath3 = 'https://img.freepik.com/premium-vector/monster-blue-golem-pixel-art-style-perfect-sticker-mascot-game-character_515427-234.jpg';
const UmbroskDeath4 = 'https://img.freepik.com/premium-vector/monster-blue-golem-pixel-art-style-perfect-sticker-mascot-game-character_515427-234.jpg';
...
const CHARACTER_POSITIONS = {
  ...
  DIALOGUE_UMBROSK_RIGHT: '50px',
  DIALOGUE_UMBROSK_BOTTOM: '120px',
  // Battle scene positioning
  BATTLE_ADVENTURER_LEFT: '500px',
  BATTLE_ADVENTURER_BOTTOM: '120px',
  BATTLE_UMBROSK_RIGHT: '420px',
  BATTLE_UMBROSK_BOTTOM: '180px',
};
...
const UmbroskSprite = ({ state, isDamaged, ...props }) => {
  const [currentFrame, setCurrentFrame] = useState(0);
  ...
  const getUmbroskFrame = () => {
    switch (state) {
      case 'attack':
        switch (currentFrame) {
          case 0: return UmbroskAttack1;
          case 1: return UmbroskAttack2;
          case 2: return UmbroskAttack3;
          case 3: return UmbroskAttack4;
          default: return UmbroskAttack1;
        }
      case 'hurt':
        switch (currentFrame) {
          case 0: return UmbroskHurt1;
          case 1: return UmbroskHurt2;
          case 2: return UmbroskHurt3;
          default: return UmbroskHurt1;
        }
      case 'death':
        switch (currentFrame) {
          case 0: return UmbroskDeath1;
          case 1: return UmbroskDeath2;
          case 2: return UmbroskDeath3;
          case 3: return UmbroskDeath4;
          default: return UmbroskDeath1;
        }
      default: // idle
        switch (currentFrame) {
          case 0: return UmbroskIdle1;
          case 1: return UmbroskIdle2;
          case 2: return UmbroskIdle3;
          case 3: return UmbroskIdle4;
          default: return UmbroskIdle1;
        }
    }
  };

  const UmbroskImg = styled('img')(({ isDamaged, state }) => ({
    width: '300px',
    height: 'auto',
    filter: 'drop-shadow(0 8px 16px rgba(0,0,0,0.5))',
  ...
  return <UmbroskImg src={getUmbroskFrame()} isDamaged={isDamaged} state={state} {...props} />;
};
...
const PositionedUmbrosk = styled(Box)(({ theme }) => ({
  position: 'absolute',
  right: CHARACTER_POSITIONS.DIALOGUE_UMBROSK_RIGHT,
  bottom: CHARACTER_POSITIONS.DIALOGUE_UMBROSK_BOTTOM,
  zIndex: 4,
}));
...
const BattleUmbrosk = styled(Box)(({ theme }) => ({
  position: 'absolute',
  right: CHARACTER_POSITIONS.BATTLE_UMBROSK_RIGHT,
  bottom: CHARACTER_POSITIONS.BATTLE_UMBROSK_BOTTOM,
  zIndex: 4,
}));
...
// Hard level questions for Umbrosk (8 questions in the requested flow)
const umbroskQuestions = [
  // Question 1: Reading Comprehension
  { type: 'reading_comprehension', passage: 'The gate before Dysauron\'s lair stood silent and foreboding. Umbrosk, the right hand of darkness, emerged from the shadows with the silence of the abyss. His presence carried the weight of stolen breath and silenced voices.',
    causeOptions: ['Gate stood silent', 'Umbrosk emerged from shadows', 'Presence carried weight'],
    effectOptions: ['Foreboding atmosphere', 'Silence spread', 'Voices were stolen'],
    correctMatches: [{ cause: 'Umbrosk emerged from shadows', effect: 'Silence spread' }] },
  // Question 2: 4 Pics 1 Word
  { type: '4pics1word', images: ['https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbKGW-1rkI0UcD7iqD1WI1G8cg9rtxxA1-CT28OeWjZZe9WqPfCqU7H4a0iC_UO1XjVaE&usqp=CAU',
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLkkP2FHHlPIfhZR3XIJTVitAtfkGVhYK7PBUL3IKgUkUzOl8rgWZiQmtdEg_iCMgzsxM&usqp=CAU',
    'https://www.timeforkids.com/wp-content/uploads/2018/08/Storms-Image2.jpg?w=1024',
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6DLHQFoCKJylGe-jXB2mj5CC0_WUVNi05xw&s'], letters: 'STORMSDW', correct: 'STORM' },
  // Question 3: Reading Comprehension
  { type: 'reading_comprehension', passage: 'The chosen one faced Umbrosk with determination, drawing their weapon against the shadow that lingers even when light returns. Bold words were spoken, but the true test was whether they could speak when their breath was stolen.',
    causeOptions: ['Chosen one faced Umbrosk', 'Weapon was drawn', 'Bold words were spoken'],
    effectOptions: ['Determination was shown', 'Shadow was challenged', 'Test began'],
    correctMatches: [{ cause: 'Chosen one faced Umbrosk', effect: 'Test began' }] },
  // Question 4: Spelling
  { type: 'spelling', definition: 'Spell the word meaning complete absence of sound or noise.', correct: 'SILENCE' },
  // Question 5: Spelling
  { type: 'spelling', definition: 'Spell the word meaning a deep, dark, seemingly bottomless chasm.', correct: 'ABYSS' },
  // Question 6: Reading Comprehension
  { type: 'reading_comprehension', passage: 'Even broken shadows return, and the master waits beyond the gate. Dysauron will silence the chosen one forever, but the adventurer\'s will remains unbroken. The path is open, but so is the danger.',
    causeOptions: ['Shadows return', 'Master waits beyond gate', 'Path is open'],
    effectOptions: ['Danger increases', 'Silence threatens', 'Will is tested'],
    correctMatches: [{ cause: 'Master waits beyond gate', effect: 'Danger increases' }] },
  // Question 7: 4 Pics 1 Word
  { type: '4pics1word', images: ['https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1X6m6RYCdUhxMAc_ae-w-Z8pj0Mv8kLp9_Q&s',
    'https://miro.medium.com/v2/resize:fit:1200/1*Q9bfz0wD837_Irn20O-ERA.jpeg',
    'https://media.istockphoto.com/id/1003489906/vector/woman-looking-in-a-mirror.jpg?s=612x612&w=0&k=20&c=FGC7t2X4ScZtCmYy7QmIsJjeZ-i0Awz6erGGyz7Mzls=',
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4wHpAJZFIeh2zTezmjy1gJoToH55pv8G2SG7yARFfAm8LLZC1LGcAp1QbsQm9BrPkNmI&usqp=CAU'], letters: 'MIRRORSDW', correct: 'MIRROR' },
  // Question 8: Multiple Choice
  { type: 'multiple_choice', question: 'What does "foreboding" mean?', options: ['Promising', 'Ominous', 'Cheerful', 'Bright'], correctAnswer: 1 }
];

const dialogueSequence = [
  { speaker: 'Wizard', text: "This is it. The gate before Dysauron's lair. But no one passes freely… his right hand, Umbrosk, waits here." },
  { speaker: 'Wizard', text: "Be wary—he carries the silence of the abyss." },
  { speaker: 'Adventurer', text: "Then I'll break his silence… with every word I know." },
  { speaker: 'Umbrosk', text: "Chosen one… I've watched you crawl through webs, timelines, and swamps. You've slain Dysauron's pawns…" },
  { speaker: 'Umbrosk', text: "But I am no pawn. I am the hand that strikes, the voice that silences, the shadow that lingers even when the light returns." },
  { speaker: 'Adventurer', text: "If you're the right hand, I'll cut you off." },
  { speaker: 'Umbrosk', text: "Bold words. Let's see if you can speak them when your breath is stolen." },
];

const victoryDialogue = [
  { speaker: 'Umbrosk', text: "So… you wield more than words… You wield will…" },
  { speaker: 'Umbrosk', text: "But… even broken shadows return… and my master waits." },
  { speaker: 'Umbrosk', text: "Dysauron will silence you… forever." },
  { speaker: 'Adventurer', text: "Then let him try." },
  { speaker: 'Wizard', text: "The path is open… but so is the danger. Dysauron awaits, and he is unlike anything you've faced." },
];

const ShadowIslesLevel4 = () => {
  ...
  const [umbroskState, setUmbroskState] = useState('idle');
  ...
  useEffect(() => {
    if (phase === 'battle') {
      const question = umbroskQuestions[currentQuestion];
      if (question) {
        setSelectedAnswer(null);
        setShowResult(false);
        setSelectedLetters([]);
  ...
  const handleAnswer = (idx) => {
    ...
    setTimeout(() => {
      const isCorrect = idx === umbroskQuestions[currentQuestion].correctAnswer;
  ...
  const processAnswer = (isCorrect) => {
    ...
    if (isCorrect) {
      ...
      setUmbroskState('hurt');
      setTimeout(() => setUmbroskState('idle'), 500);
      
      setMonsterDamaged(true);
      setTimeout(() => setMonsterDamaged(false), 500);
      
      setMonsterHP(hp => {
        const newHP = Math.max(0, hp - Math.floor(100 / umbroskQuestions.length));
        if (currentQuestion === umbroskQuestions.length - 1 || newHP === 0) {
          setUmbroskState('death');
      ...
      if (currentQuestion < umbroskQuestions.length - 1) {
        setTimeout(() => {
  ...
  if (phase === 'dialogue') {
    ...
    content = (
      <>
        ...
        <BattleUmbrosk>
          <UmbroskSprite state={umbroskState} isDamaged={monsterDamaged} />
        </BattleUmbrosk>
        
        {/* HP UI */}
        <Box sx={{
          position: 'absolute',
          right: `calc(${CHARACTER_POSITIONS.BATTLE_UMBROSK_RIGHT} + 60px)`,
          bottom: `calc(${CHARACTER_POSITIONS.BATTLE_UMBROSK_BOTTOM} + 220px)`,
          zIndex: 10,
          transform: 'translateX(-50%)',
        }}>
          <MonsterHPText>Umbrosk HP</MonsterHPText>
          <MonsterHPBar>
      ...
      {victory && (
        <VictoryOverlay>
          <VictoryContainer elevation={12}>
            ...
            <Button
              variant="contained"
              onClick={() => navigate('/shadow-isles/level5')}
              style={{
                background: 'linear-gradient(145deg, #4CAF50 0%, #45a049 50%, #3d8b40 100%)',
                color: '#fff',
                fontFamily: '"Segoe UI", Tahoma, Geneva, Verdana, sans-serif',
...
export default ShadowIslesLevel4;
