    ...
    <div className="arcade-profile-stat-label">Progress Points</div>
            ...
            <Box className="arcade-profile-modes-row">
              <Box 
                ...
                sx={{ cursor: 'pointer' }}
              >
                <div className="arcade-profile-mode-img" style={{height: '160px', marginBottom: '10px', borderRadius: '0px', overflow: 'hidden', boxShadow: '0 4px 18px #00eaff33'}}><img src="/game-thumbnail/adventure_mode.png" alt="Adventure Mode" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0' }} /></div>
              ...
              <Box 
                ...
                sx={{ cursor: 'pointer' }}
              >
                <div className="arcade-profile-mode-img" style={{height: '160px', marginBottom: '10px', borderRadius: '0px', overflow: 'hidden', boxShadow: '0 4px 18px #00eaff33'}}><img src="/game-thumbnail/time_attack.png" alt="Custom Word List" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0' }} /></div>
              ...
              <Box 
                ...
                sx={{ cursor: 'pointer' }}
              >
                <div className="arcade-profile-mode-img" style={{height: '160px', marginBottom: '10px', borderRadius: '0px', overflow: 'hidden', boxShadow: '0 4px 18px #00eaff33'}}><img src="/game-thumbnail/four_pic_one_word.png" alt="4pics1word Mode" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0' }} /></div>
              ...
              <Box 
                ...
                sx={{ cursor: 'pointer' }}
              >
                <div className="arcade-profile-mode-img" style={{height: '160px', marginBottom: '10px', borderRadius: '0px', overflow: 'hidden', boxShadow: '0 4px 18px #00eaff33'}}><img src="/game-thumbnail/word_of_the_day.png" alt="Word of the Day" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '0' }} /></div>
